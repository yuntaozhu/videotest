...
export const FengtaiLogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const AirplaneLogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const RobotHand: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const AiMagnifyIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const AiScreenIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
